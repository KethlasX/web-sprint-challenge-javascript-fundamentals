...
// The nestedFunction can access internal because it is still within the scope of myFunction.
...
// console.log(animalNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    return array.filter(array => array.population < 5);
  }
  ...
  */
  ...
  function USApop(array){
    // array.forEach(pop => console.log(pop.population))
    let USA = array.reduce(
